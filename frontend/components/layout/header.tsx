...
import { BookOpen, Plus, Flame, Zap } from "lucide-react";
...
export default function DashboardLayout({ children }: DashboardLayoutProps) {
  ...
  // const { paths, fetchPaths } = useLearningStore();
  // const { weekly, myRank, fetchWeekly, fetchMyRank } = useLeaderboardStore();
  ...
  return (
    <div className="flex h-screen bg-[#F7F7F5] font-sans overflow-hidden">
      {/* Sidebar */}
      <aside className="w-[240px] min-w-[240px] flex flex-col bg-white border-r border-black/[0.07]">
        {/* Logo */}
        <div className="px-5 py-[18px] border-b border-black/[0.07]">
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        {/* Topbar */}
        <header className="h-[52px] min-h-[56px] bg-white border-b border-black/[0.07] flex items-center justify-between px-6">
        ...
        <div className="flex-1 overflow-hidden flex">
          ...
          {/* Leaderboard panel */}
          <aside className="w-[260px] min-w-[260px] border-l border-black/[0.07] bg-white overflow-y-auto">
